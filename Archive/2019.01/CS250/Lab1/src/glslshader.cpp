...
{
  // @todo: This function opens a file called file_name, reads the text from
  // the file into a string and then calls 
  // GLSLShader::CompileShaderFromString() to compile the shader source.
  // Read function header in glslshader.h for more details.
  

  // Intentionally comment out definition below to ensure that source will
  // not compile until function is implemented.
  // Note: buffer must contain the contents of the shader source file!!!
  string line;
  stringstream buffer;
  ifstream inFile;

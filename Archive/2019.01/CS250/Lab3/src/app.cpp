...
*/
bool App::init(GLint w, GLint h, std::string t) {
  App::width = w;
  App::height = h;
  App::title = t;
  ...
  glfwSetErrorCallback(App::error_cb);
  ...
  App::ptr_window = glfwCreateWindow(width, height, title.c_str(), NULL, NULL);
  if (!App::ptr_window) {
  ...
  glfwMakeContextCurrent(App::ptr_window);

  // set callback for events associated with window size changes; keyboard;
 // mouse buttons, cursor position, and scroller
  glfwSetFramebufferSizeCallback(App::ptr_window, App::fbsize_cb);
  glfwSetKeyCallback(App::ptr_window, App::key_cb);
  glfwSetMouseButtonCallback(App::ptr_window, App::mousebutton_cb);
  glfwSetCursorPosCallback(App::ptr_window, App::mousepos_cb);
  glfwSetScrollCallback(App::ptr_window, App::mousescroll_cb);

  // this is the default setting ...
  glfwSetInputMode(App::ptr_window, GLFW_CURSOR, GLFW_CURSOR_NORMAL);
  ...
  App::fbsize_cb(ptr_window, width, height);
...
*/
void App::key_cb(GLFWwindow *pwin, int key, int scancode, int action, int mod) {
...
*/
void App::mousebutton_cb(GLFWwindow *pwin, int button, int action, int mod) {
  switch (button) {
...
*/
void App::mousepos_cb(GLFWwindow *pwin, double xpos, double ypos) {
#ifdef _DEBUG
...
*/
void App::mousescroll_cb(GLFWwindow *pwin, double xoffset, double yoffset) {
#ifdef _DEBUG
...
*/
void App::error_cb(int error, char const* description) {
...
*/
void App::fbsize_cb(GLFWwindow *ptr_win, int width, int height) {
...
*/
double App::update_time(double fps_calc_interval) {

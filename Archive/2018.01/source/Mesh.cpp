...
\brief
        Contains the functions needed to make and maintain a set of points 
        images and colors can be displayed this way
*/
/******************************************************************************/
...
******************************************************************************/
  ...
  Mesh::Mesh()
  {
    Vertex verts[] =
    {
      { XMFLOAT3(-5.5f, 5.5f, 0.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },//0
      { XMFLOAT3( 5.5f, 5.5f, 0.0f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },//1
      { XMFLOAT3( 5.5f,-5.5f, 0.0f), XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f) },//2
      { XMFLOAT3(-5.5f, 5.5f, 0.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },//0
      { XMFLOAT3( 5.5f,-5.5f, 0.0f), XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f) },//2
      { XMFLOAT3(-5.5f,-5.5f, 0.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },//3
    };
